...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/rgap/Desktop/nodejs_curso/10_database_sql/7_prisma_organized_controllers/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/rgap/Desktop/nodejs_curso/10_database_sql/7_prisma_organized_controllers/prisma/schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  },
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "mysql://root:root@localhost:3306/testdb"
      }
    }
  },
  "inlineSchema": "// Model: Defines the structure of your database tables and relationships\n// Prisma will generate the necessary SQL and a type-safe client to interact with these models\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = \"mysql://root:root@localhost:3306/testdb\"\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  name      String\n  email     String   @unique\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  @@map(\"user\")\n}\n",
  "inlineSchemaHash": "ddd157f29212cf861cdd2c7c970e31e5cee7b8b122749f6d2506039424acad46",
  "copyEngine": true
}
