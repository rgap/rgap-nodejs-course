...
export { Agent, BalancedPool, buildConnector, Client, connect, DecoratorHandler, Dispatcher, errors, getGlobalDispatcher, getGlobalOrigin, MockAgent, MockClient, mockErrors, MockPool, pipeline, Pool, ProxyAgent, RedirectHandler, request, RetryAgent, RetryHandler, setGlobalDispatcher, setGlobalOrigin, stream, upgrade }
